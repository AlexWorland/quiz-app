...
export function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.avatar_url) newErrors.avatar = 'Avatar is required'
    setErrors(newErrors)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-950 to-dark-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-dark-900 rounded-lg shadow-xl p-8">
        <h1 className="text-3xl font-bold text-white mb-2">Join Quiz App</h1>
        <p className="text-gray-400 mb-6">Create your account and start learning</p>
