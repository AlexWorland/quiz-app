...
export function SegmentLeaderboard({ rankings, showTieTooltip = true }: SegmentLeaderboardProps) {
  ...
  return (
    <div className="bg-dark-900 rounded-lg p-6">
      <h2 className="text-2xl font-bold text-white mb-4">Segment Leaderboard</h2>
      ...
      <div className="space-y-3">
        {rankings.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 text-sm">Quiz hasn't started or no one has joined</p>
          </div>
